...
<body>
    <div class="container">
        <?php
            ...
            $sql = 'SELECT diemsinhvien.ID, diemsinhvien.TenSV ,diemsinhvien.Diem FROM diemsinhvien WHERE MAGiangVien = "'.$_POST['id'].'"';
             var_dump($sql);
        ...
        if (isset($_POST['submit'])) {
            ...
            $update = 'UPDATE diemsinhvien SET ID = "'.$id1.'",  TenSV = "'.$tenmoi.'" ,Diem = "'.$diem.'"  WHERE ID = "'.$id1.'" ';
